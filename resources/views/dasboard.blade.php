    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <h1 class="app-page-title">Overview Dasboard</h1>
			    
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						    <h3 class="mb-3">Welcome, {{Auth::user()->role->name}}!</h3>
			    ...
			    <div class="row g-4 mb-4">
					<div class="col-6 col-lg-3">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								...
								<div class="stats-figure">Rp.{{ number_format($totalNominalPemasukan, 2) }}</div>
							...
							<a class="app-card-link-mask" href="/pemasukan"></a>
						</div>
					</div>
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Total Pengeluaran</h4>
							    <div class="stats-figure">Rp.{{ number_format($totalNominalPengeluaran, 2) }}</div>
							    <div class="stats-meta text-success">
								    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
</svg> </div>
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="/pengeluaran"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Total Saldo</h4>
								<div class="stats-figure">Rp. {{ number_format($saldo, 0, ',', '.') }}</div>
								<div class="stats-meta">
									Pemasukan: Rp. {{ number_format($totalNominalPemasukan, 0, ',', '.') }}<br>
									Pengeluaran: Rp. {{ number_format($totalNominalPengeluaran, 0, ',', '.') }}
								</div>
							</div>
						    </div><!--//app-card-body-->
				...
				<script src="https://cdn.jsdelivr.net/npm/chart.js"></script><!--//row-->
	    ...
	    <footer class="app-footer">
            ...
            <small class="copyright">Designed with <span class="sr-only">love</span><i class="fas fa-heart" style="color: #fb866a;"></i> by <a class="app-link" href="http://themes.3rdwavemedia.com" target="_blank">Apipp</a> for developers</small>
	...
	<script>
		...
		var barChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: 'Data Example',
					data: [10, 20, 30, 40, 50, 60], // Data yang ditampilkan
					backgroundColor: [
						'rgba(255, 99, 132, 0.2)',
						'rgba(54, 162, 235, 0.2)',
						'rgba(255, 206, 86, 0.2)',
	...
	<script>
		...
		var lineChart = new Chart(ctx, {
			...
			data: {
				labels: ['January', 'February', 'March', 'April', 'May', 'June'], // Label data
				datasets: [{
					label: 'Data Example', // Label dataset
					data: [12, 19, 3, 5, 2, 3], // Data yang akan ditampilkan di chart
