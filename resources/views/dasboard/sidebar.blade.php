{{-- <nav class="navbar col-12 col-sm-12 col-md-12 col-lg-12">
   
    <div class="container">
        <div class="">
            <h3>Family Cash Flow</h3>
        </div>
      <ul class="menu">
  ...
  <div class="sidebar">
    ...
    <ul class="menu-sidebar">
      <li class="nav-item active">
        <a class="nav-link hover:underline"   href="{{route('dasboard')}}"><p>Dasboard</p></a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="{{route('pemasukan')}}"><p>Pemasukan</p></a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="{{route('pengeluaran')}}"><p>Pengeluaran</p></a>
      </li>
...
<script>
// let dasboard = document.getElementById("dasboard");
// let pemasukan = document.getElementById("pemasukan");
// let pengeluaran = document.getElementById("pengeluaran");
// let history = document.getElementById("history");

// let main_dasboard = document.getElementById("main-dasboard");

// dasboard.addEventListener('click',function(){
    
//     main_dasboard.style.display = 'block';
//     dasboard.style.background = 'white';
//     dasboard.style.color = '#134B70';
//     pemasukan.style.background = '#134B70';
//     pemasukan.style.color = 'white';
//     pengeluaran.style.background = '#134B70';
//     pengeluaran.style.color = 'white';
//     history.style.background = '#134B70';
//     history.style.color = 'white';
// });

// pemasukan.addEventListener('click',function(){

//     dasboard.style.background = '#134B70';
//     dasboard.style.color = 'white';
//     pemasukan.style.background = 'white';
//     pemasukan.style.color = '#134B70';
//     pengeluaran.style.background = '#134B70';
//     pengeluaran.style.color = 'white';
//     history.style.background = '#134B70';
//     history.style.color = 'white';

//     main_dasboard.style.visibility = 'invisible';
//     main_dasboard.style.display = 'none';
// });
...
//     pemasukan.style.background = '#134B70';
//     pemasukan.style.color = 'white';
//     pengeluaran.style.background = 'white';
//     pengeluaran.style.color = '#134B70';
//     history.style.background = '#134B70';
//     history.style.color = 'white';
// });
...
<div style="display: flex">
      <li class="nav-item" >
        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
      <!--//nav-link-->
        <span class="logo-text"><h3>FamilyCashFlow</h3></span>
    </li><!--//nav-item-->
  </div>
  <br>
      <li class="nav-item">
...
<path fill-rule="evenodd" d="M13.81 4H2.19a1 1 0 0 0-.996 1.09l.637 7a1 1 0 0 0 .995.91h10.348a1 1 0 0 0 .995-.91l.637-7A1 1 0 0 0 13.81 4zM2.19 3A2 2 0 0 0 .198 5.181l.637 7A2 2 0 0 0 2.826 14h10.348a2 2 0 0 0 1.991-1.819l.637-7A2 2 0 0 0 13.81 3H2.19z"/>
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="{{route('pengeluaran')}}">
          <span class="nav-icon">
          <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trolly" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path d="M9.828 4a3 3 0 0 1-2.12-.879l-.83-.828A1 1 0 0 0 6.173 2H2.5a1 1 0 0 0-1 .981L1.546 4h-1L.5 3a2 2 0 0 1 2-2h3.672a2 2 0 0 1 1.414.586l.828.828A2 2 0 0 0 9.828 3v1z"/>
<path fill-rule="evenodd" d="M13.81 4H2.19a1 1 0 0 0-.996 1.09l.637 7a1 1 0 0 0 .995.91h10.348a1 1 0 0 0 .995-.91l.637-7A1 1 0 0 0 13.81 4zM2.19 3A2 2 0 0 0 .198 5.181l.637 7A2 2 0 0 0 2.826 14h10.348a2 2 0 0 0 1.991-1.819l.637-7A2 2 0 0 0 13.81 3H2.19z"/>
</svg>
           </span>
