      ...
      <tbody>
          <tr>
            ...
            <td>
              ...
              -
              @else
              <a href="pengeluaran-edit/{{$item->id}}"><button class="btn btn-warning">Edit</button></a>
              <a href="pengeluaran-delete/{{$item->id}}"><button class="btn btn-danger">Delete</button></a>
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Pengeluaran</h1>
				    </div>
            
                <a href="{{route('pengeluaran-add')}}"><button type="submit" class="btn btn-primary">+Tambah</button></a>
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    ...
							    <div class="col-auto">						    
								    <a class="btn app-btn-secondary" href="http://127.0.0.1:8000/export-pengeluaran">
                          ...
                          <tbody>
                              <tr>
                                ...
                                <td>
                                  ...
                                  @else
                                  <a href="pengeluaran-edit/{{$item->id}}"><button class="btn btn-warning">Edit</button></a>
                                  <a href="pengeluaran-destroy/{{$item->id}}"><button class="btn btn-danger">Delete</button></a>
